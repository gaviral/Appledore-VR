...
public class displayPrefabs : MonoBehaviour {
    ...
    void spawnAnimals() {
        ...
        prefab2.transform.localPosition = new Vector3(36, -62, -62);
        ...
        GameObject prefab4 = Instantiate(object2, canvas.transform.position,
        ...
        GameObject prefab5 = Instantiate(object2, canvas.transform.position,
            Quaternion.Euler(new Vector3(0, 200, 0)), canvas.transform) as GameObject;
        prefab5.transform.localScale = new Vector3(34, 34, 34);
        prefab5.transform.localPosition = new Vector3(96, -62, -62);
    }
}
